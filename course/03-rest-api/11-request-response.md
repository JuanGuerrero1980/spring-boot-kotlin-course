...
Resolvé estos ejercicios en tu cuaderno. Las respuestas están debajo de cada uno y también en `exercises/solutions/11-request-response-solutions.md`.
...
* `Content-Type` indica el formato del body que se está enviando o devolviendo. Ejemplo: `application/json`.
* `Accept` indica qué formatos de respuesta acepta el cliente. Ejemplo: `application/json`.
